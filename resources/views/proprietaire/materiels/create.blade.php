            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card shadow">
                        <div class="card-header bg-primary text-white fw-bold">Nouveau Matériel à Louer</div>
                        <div class="card-body">
                            <form action="{{ route('proprietaire.materiels.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('prixLocation') is-invalid @enderror"
                                            id="prixLocation" name="prixLocation" value="{{ old('prixLocation') }}" required min="0.01">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('type_materiel_id') is-invalid @enderror" id="type_materiel_id"
                                            ...
                                            <option value="{{ $type->id }}"
                                                {{ old('type_materiel_id') == $type->id ? 'selected' : '' }}>{{ $type->nom }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <button type="submit" class="btn btn-primary w-100 mt-3">Créer le Matériel</button>
                            </form>
                        </div>
                    </div>
                </div>
